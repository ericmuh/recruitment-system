...
class Clearance(models.Model):
    ...
    clearance_file = models.ForeignKey(
        "files.ClearanceFile", blank=True, null=True, on_delete=models.SET_NULL)
    submission_date = models.DateTimeField(null=True, blank=True)
    position_on_clearance = models.CharField(
...
class Contract(models.Model):
    ...
    employer = models.ForeignKey(
        "settings.Employer", on_delete=models.CASCADE, blank=True, null=True)
    submission_date = models.DateTimeField(null=True, blank=True)
    status = models.IntegerField(choices=STATUS_CHOICES, default=PENDING)
...
class Interview(models.Model):
    ...
    prev_employer = models.CharField(
        "Previous Employer", max_length=200, blank=True)
...
class Medical(models.Model):
    ...
    medical_type = models.IntegerField(
        choices=TYPE_CHOICES, default=PREMEDICALS)
    status = models.IntegerField(choices=STATUS_CHOICES, default=PENDING)
    document = models.FileField(upload_to='clients/%Y/%m/%d/', blank=True)
    created = models.DateField(default=timezone.now)
...
class Passport(models.Model):
    ...
    agent = models.ForeignKey(
        "settings.Agent", null=True, blank=True, on_delete=models.SET_NULL)
    passport_no = models.CharField(
        "Passport Number", max_length=100, unique=True, blank=True, null=True)
    nationality = models.CharField(max_length=100, blank=True)
...
class Ticket(models.Model):
    ...
    ticket_no = models.CharField(
        "Ticket Number", max_length=100, unique=True, blank=True, null=True)
...
class Training(models.Model):
    ...
    center = models.ForeignKey(
        "settings.TrainingCenter", null=True, blank=True, on_delete=models.SET_NULL)
...
class Vetting(models.Model):
    ...
    destination = models.ForeignKey(
        "settings.Destination", null=True, blank=True, on_delete=models.SET_NULL)
    employer = models.ForeignKey(
        "settings.Employer", null=True, blank=True, on_delete=models.SET_NULL)
...
class Visa(models.Model):
    ...
    visa_no = models.CharField(
        "Visa Number", max_length=100, unique=True, blank=True, null=True)
    issue_date = models.DateTimeField(null=True, blank=True)
